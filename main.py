...
def instance_manage(selected_instances):
    print(f'''
        ...
        del - удалить;
        move - перенести машину в другой каталог;
        restart - перезагрузить машину;
        resize - изменить размер диска виртуальной машины;
        snapshot - показать данные снимка;
...
if __name__ == '__main__':
    ...
    # print(create_virtual_machines(folder.id))
    check_instances()